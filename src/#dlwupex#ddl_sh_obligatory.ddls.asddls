@AbapCatalog.sqlViewName: '/DLWUPEX/V_SH_OG'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Cds for SH domain DOBLIGAT_MOD'
define view /DLWUPEX/DDL_SH_OBLIGATORY
...
where
  _desc.domname = '/DLWUPEX/DOBLIGAT_MOD'
