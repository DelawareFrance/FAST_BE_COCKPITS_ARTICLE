*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/DLWUPEX/V_VAR_H
*   generation date: 29.10.2019 at 15:00:45
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/DLWUPEX/V_VAR_H    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/DLWUPEX/V_VAR_H'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /DLWUPEX/V_VAR_H_EXTRACT
TOTAL = /DLWUPEX/V_VAR_H_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/DLWUPEX/V_VAR_H'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/DLWUPEX/V_VAR_H-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /DLWUPEX/V_VAR_H_EXTRACT
TOTAL = /DLWUPEX/V_VAR_H_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/DLWUPEX/V_VAR_H-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/DLWUPEX/V_VAR_H'
...
TOTAL = /DLWUPEX/V_VAR_H_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/DLWUPEX/V_VAR_H-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/DLWUPEX/V_VAR_H-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/DLWUPEX/V_VAR_H'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/DLWUPEX/V_VAR_H-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /DLWUPEX/V_VAR_H_EXTRACT
TOTAL = /DLWUPEX/V_VAR_H_TOTAL
